...
| `/api/public/v1/stock_cn_hist` | GET | On-demand | `symbol`(req), `source`(eastmoney/sina/tencent), `start_date`, `end_date`, `adjust` |
| `/api/public/v1/stock_cn_hist_intraday` | GET | On-demand | `symbol`(req), `source`(eastmoney/sina), `period`(1/5/15/30/60), `start_date`(eastmoney only), `end_date`, `adjust` |
...
| `/api/public/v1/bond_cov_hist` | GET | On-demand | `symbol`(req, e.g. sh010107) |
